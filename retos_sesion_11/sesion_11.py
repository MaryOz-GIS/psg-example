...
#no permiten claves duplicadas se reescribe el valor de la clave
...
# recibe una clave y retorna el valor del par clave-valor, si la clave no existe retorna none
...
#retorna una lista de tuplas con los pares clave-valor, se puede iterar para obtener los pares clave-valor
print ("Método items()")
diccionario = {'perro': '🐶', 'gato': '🐱', 'ave': '🐦'}
print(diccionario)
...
#retorna una lista con las claves del diccionario, se puede iterar para obtener las claves
print ("Método keys()")
diccionario = {'perro': '🐶', 'gato': '🐱', 'ave': '🐦'}
print(diccionario)
...
#retorna una lista con los valores del diccionario, se puede iterar para obtener los valores
print ("Método values()")
diccionario = {'perro': '🐶', 'gato': '🐱', 'ave': '🐦'}
print(diccionario)
...
#recibe un diccionario y agrega los pares clave-valor al diccionario, si la clave ya existe reescribe el valor
...
#recibe claves y valores, agrega el par clave-valor al diccionario, si la clave ya existe reescribe el valor
...
# elimina el último par clave-valor del diccionario, retorna el par clave-valor,
# si el diccionario está vacío retorna un error
...
#retorna la cantidad de pares clave-valor del diccionario
print ("Función len()")
diccionario = {'perro': '🐶', 'gato': '🐱', 'ave': '🐦'}
print(diccionario)
...
#recibe items del diccionario y retorna un iterador
print ("Función iter()")
diccionario = {'perro': '🐶', 'gato': '🐱', 'ave': '🐦'}
print(diccionario)
...
#diccionarios pueden contener otros diccionarios
